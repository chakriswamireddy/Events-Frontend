...
export function DateTimePicker({dateTime,setDateTime}) {
  const form = useForm({
  ...
  function handleDateSelect(date) {
    if (date) {
      ...
      setDateTime(new Date(date).toISOString());
    }
  }
  ...
  function handleTimeChange(type, value) {
    ...
    setDateTime(new Date(newDate).toISOString());
  }

  useEffect(()=> {

    dateTime && form.setValue("time",  new Date(dateTime));
